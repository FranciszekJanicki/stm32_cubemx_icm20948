...
{
    (void)user;
    HAL_I2C_Mem_Write(&hi2c1, ICM_20948_I2C_ADDR_AD0 << 1, reg, sizeof(reg), data, len, 100);
    return ICM_20948_Stat_Ok;
}
static ICM_20948_Status_e read(uint8_t reg, uint8_t* data, uint32_t len, void* user)
{
    (void)user;
    HAL_I2C_Mem_Read(&hi2c1, ICM_20948_I2C_ADDR_AD0 << 1, reg, sizeof(reg), data, len, 100);
    return ICM_20948_Stat_Ok;
}
...
static void init_dmp()
{
    ...
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_00, 4, b2s_mount_multiplier_plus);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_01, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_02, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_10, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_11, 4, b2s_mount_multiplier_plus);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_12, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_20, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_21, 4, b2s_mount_multiplier_zero);
    inv_icm20948_write_mems(&icm_dev, B2S_MTX_22, 4, b2s_mount_multiplier_plus);
    ...
    // Jeszcze zobaczymy
    // en.DMP_INT1_EN = true;
    // ICM_20948_int_enable(&icm_dev,&en,&en);
}
...
void icm_sensor_init(void)
{
    ...
    inv_icm20948_set_dmp_sensor_period(&icm_dev, DMP_ODR_Reg_Gyro_Calibr, 0);
...
void icm_sensor_read(icm_sensor_data_t* data)
{
    ...
    if (reading.header & DMP_header_bitmap_Gyro) {
        ...
        data->bias_gyr_x = reading.Raw_Gyro.Data.BiasX;
        data->bias_gyr_y = reading.Raw_Gyro.Data.BiasY;
        data->bias_gyr_z = reading.Raw_Gyro.Data.BiasZ;
    }
